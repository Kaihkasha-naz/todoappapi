...
Clone the Repository: git clone cd todo api

Install Dependencies: npm install

Set Up Environment Variables: Create a .env file in the root of the project and add the following: PORT=5000 MONGO_URI= JWT_SECRET=
...
Headers: { "Authorization": "Bearer " }
Notes
Replace in the headers with the token received after login.
Ensure MongoDB is running and accessible via the connection string provided in the .env file.
Technologies Used
. Node.js . Express.js . MongoDB . bcrypt for password hashing . jsonwebtoken (JWT) for authentication . dotenv for environment variables
